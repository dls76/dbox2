...
const pessoas = [
    ...
    //Março
    {nome: "Rosiane Gonzales dos Reis", data: new Date(2024, 2, 2), dia: 2, mes: 2, ano: 1971, funcao: "Função", foto: 'img/anivImg/marco/rosiane.jpg'},
    {nome: "Fillipe Alves Leite", data: new Date(2024, 2, 8), dia: 8, mes: 2, ano: 1986, funcao: "Função", foto: 'img/anivImg/marco/fillipeleite.jpg'},
    {nome: "Sarita Vieira Santos", data: new Date(2024, 2, 14), dia: 14, mes: 2, ano: 1981, funcao: "Função", foto: 'img/anivImg/marco/sarita.jpg'},
    {nome: "Paulo Henrique Mandoio Diniz", data: new Date(2024, 2, 18), dia: 18, mes: 2, ano: 1995, funcao: "Função", foto: 'img/anivImg/marco/paulo.jpg'},
    {nome: "Douglas Leal dos Santos", data: new Date(2024, 2, 20), dia: 20, mes: 2, ano: 1976, funcao: "Função", foto: 'img/anivImg/marco/dls.png'},
    {nome: "Alexandro Antonio Procopio Gaspar ", data: new Date(2024, 2, 29), dia: 29, mes: 2, ano: 1981, funcao: "Função", foto: 'img/anivImg/marco/alexandro.jpg'},

...
function carregarCelebras() {
    ...
    const celebras = [
        ...
        {data: new Date(2024, 2, 21), responsavel: 'SOE', tema: 'Bullyng e cyberbulling  Convidada advogada da área: Dra. Angela'},
        ...
        {data: new Date(2024, 3, 18), responsavel: 'pastoral', tema: 'Lançamento MEMI e projetos espirituais  Apresentação, convite e inscrição para a comunidade Route77, ministérios e classes bíblicas'},

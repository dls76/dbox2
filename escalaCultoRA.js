...
const escalados = [
  ...
  { nome: "Carol", data: new Date(2025, 3, 8), cap: "2/1-2" },
  { nome: "Jaque", data: new Date(2025, 3, 15), cap: "2/3-4" },
  { nome: "Camila", data: new Date(2025, 3, 22), cap: "3/1-2" },
  { nome: "Valéria", data: new Date(2025, 3, 29), cap: "3/3-5" },
  { nome: "Malu", data: new Date(2025, 4, 6), cap: "4/1-2.5" },
  {
    nome: "Andressa",
    data: new Date(2025, 4, 13),
    cap: "4/3-4.5",
  },
  { nome: "Renata", data: new Date(2025, 4, 20), cap: "5/1-2" },
  { nome: "Vinícius", data: new Date(2025, 4, 27), cap: "5/3-5" },
];

...
let plantaosexta = [
    ...
    { data: new Date(2025, 5, 13), person: "Douglas", monitoria: "Wesley e Rose" },
    // { data: new Date(2025, 5, 20), person: "", monitoria: "Henrique e Eliane" },
    { data: new Date(2025, 5, 27), person: "Vinícius", monitoria: "Douglas e Lucia" },
    { data: new Date(2025, 6, 4), person: "Leonardo", monitoria: "Kadu e Carmelis" },

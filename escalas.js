...
let plantaosexta = [
    ...
    {data: new Date(2024, 4, 10), person: "Camila"}, 
    {data: new Date(2024, 4, 17), person: "Júlia"},
    {data: new Date(2024, 4, 24), person: "Carin"}, 
    {data: new Date(2024, 4, 31), person: "Recepcionista"}, 
    {data: new Date(2024, 5, 7), person: "Alícia"}, 
    {data: new Date(2024, 5, 14), person: "Promotora"}, 
    {data: new Date(2024, 5, 21), person: "Biblioteca 1"}, 
    {data: new Date(2024, 5, 28), person: "Biblioteca 2"}, 
    {data: new Date(2024, 6, 5), person: "TI"}, 

...
const proximosEventos = [
  ...
  {nome: 'Acreditação', data: new Date(2024, 3, 26), link:"https://drive.google.com/drive/u/1/folders/138CBruFqXcFV02TVsLXgUfTZ4yrlTqh9",},
  {nome: 'Dia das Mães', data: new Date(2024, 4, 5), link:"https://drive.google.com/drive/folders/1vyONKagq4wUlMKRDGutaHqidhr3WFrbC?usp=drive_link",},
  {nome: "Intercâmbio", data: new Date(2024, 4, 5), link: "https://docs.google.com/spreadsheets/d/1fszaXuiFUTxFFyIlyPBH5JAJCgAijxE1LJXaxdFa80k/edit#gid=0"},
  ...
  {nome: 'Olimpíadas do CAC', data: new Date(2024, 6, 29), link:"https://drive.google.com/drive/folders/1MeOeRl-HrD7_X-N-oTQcBAbROWVfKdOF?usp=sharing",},

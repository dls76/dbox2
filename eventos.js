...
let eventos = [
    ...
    {data1: new Date(2023, 3, 24), data2: new Date(2023, 3, 28), descritivo: "Recuperação I bim FI ao EM", cal: "asp", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    ...
    {data1: new Date(2023, 3, 26), data2: new Date(2023, 3, 26), descritivo: "Noite esportiva - 5º anos", cal: "asp", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 3, 28), data2: new Date(2023, 3, 28), descritivo: "Final do 1º bimestre", cal: "asp", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 3, 28), data2: new Date(2023, 3, 28), descritivo: "Relatório mensal de notificações para pais (impresso) - Rudi", cal: "asp", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    ...
    // MAIO
    {data1: new Date(2023, 4, 1), data2: new Date(2023, 4, 1), descritivo: "Feriado - Dia do Trabalho", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    ...
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 31), descritivo: "Reuniões Pedagógicas Individuais - FUND II e EM", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 2), descritivo: "Comissão de Educação/Diretiva", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 2), descritivo: "Data limite para o envio dos Cronogramas Avaliativos aos alunos (2º Bim)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 2), descritivo: "Início do 2º bimestre", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 2), descritivo: "“Projeto Fair Play” - Módulo Olimpíada do Conhecimento (Matemática/ Bom de Bíblia/Português/Redação) – fase unidade escolar", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 2), descritivo: "Envio do Cronograma Avaliativo II Bim - FUND II e EM", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 2), descritivo: "SAD ENCERRADO - 2º ENCERRAMENTO E ASSINATURA - I BIM", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 2), data2: new Date(2023, 4, 5), descritivo: "2ª Semana de Hábitos de Estudos - FI ao Médio", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 3), data2: new Date(2023, 4, 3), descritivo: "GEPEA Pedagógico – USB (remoto)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 5), data2: new Date(2023, 4, 5), descritivo: "Data limite para entrega das avaliações 2º Bimestre - Para Análise do SOP", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 6), data2: new Date(2023, 4, 6), descritivo: "Sábado de Liberdade Religiosa", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 7), data2: new Date(2023, 4, 7), descritivo: "Projeto Dia das Mães (Dia Letivo – dia permutado com recesso do dia 09/06)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 12), descritivo: "Período de aplicação da AV1 II BIM - corrigir, lançar notas no SAD e devolver aos estudantes até 5 dias úteis após a data da sua avaliação.", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 12), descritivo: "Aula de campo - Projeto Água - TMA Acampamentos EI-FI", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: "inf5"},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 8), descritivo: "Dia do profissional de marketing", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 8), descritivo: "Capacitação profs Mentores Chave do Enem e Aprofundamento itinerários - Presencial - 14 h - no auditório (a definir)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 12), descritivo: "Liberação para a visualização dos Pareceres e Boletins – 1º Bimestre / Entrega de boletins (Comunicar a disponibilidade no sistema)       ", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 12), descritivo: "Entrevistas UNASP e FADBA (pedagogia/licenciaturas)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 12), descritivo: "Assinatura virtual dos diários do 1º Bimestre (Conteúdos e Frequência) – SOP e secretaria             ", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 8), data2: new Date(2023, 4, 19), descritivo: "Pesquisa da equipe administrativa por todos os professores e funcionários                 ", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 9), data2: new Date(2023, 4, 11), descritivo: "Pastori - ASP", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 9), data2: new Date(2023, 4, 12), descritivo: "Feira Educar – SP (diretores, vices e tesoureiros)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 10), data2: new Date(2023, 4, 10), descritivo: "Treinamento diretores (remoto)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 14), data2: new Date(2023, 4, 14), descritivo: "Dia das Mães", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 15), data2: new Date(2023, 4, 19), descritivo: "Período de aplicação da AV1", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 15), data2: new Date(2023, 4, 19), descritivo: "Pré-conselho SOE EI-FI", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: "inf5"},
    {data1: new Date(2023, 4, 16), data2: new Date(2023, 4, 16), descritivo: "2ª Chamada AV1 - FUND II e EM", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 15), data2: new Date(2023, 4, 19), descritivo: "Encontro pedagógico individual - EI ao 1º FI", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: "inf5"},
    {data1: new Date(2023, 4, 15), data2: new Date(2023, 4, 19), descritivo: "Semana do Lenço – aventureiros (alunos e professores)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 15), data2: new Date(2023, 4, 17), descritivo: "Encontro de Secretários, bibliotecários e auxiliares, jurídico e marketing – CATRE", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 18), data2: new Date(2023, 4, 18), descritivo: "Comissão de Matemática USB (tarde)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 18), data2: new Date(2023, 4, 18), descritivo: "Treinamento de diretores (remoto)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 18), data2: new Date(2023, 4, 18), descritivo: "Reunião de Assistentes Financeiros –", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 19), data2: new Date(2023, 4, 21), descritivo: "Congresso de Liberdade Religiosa - Paraná", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 19), data2: new Date(2023, 4, 19), descritivo: "Data limite para o lançamento das notas da AV1 no SAD (prof) e Data limite para a regularização dos registros dos conteúdos do mês, no SAD ", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 20), data2: new Date(2023, 4, 20), descritivo: "Sábado da Criança e Dia Mundial dos Aventureiros", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 4, 22), data2: new Date(2023, 4, 22), descritivo: "Dia do abraço - SOE - FUND I", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: "inf5"},
    ...
    // JUNHO
    {data1: new Date(2023, 5, 1), data2: new Date(2023, 5, 30), descritivo: "Pesquisa de satisfação (Pais e responsáveis)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 1), data2: new Date(2023, 5, 30), descritivo: "Remediação da EI 5 anos", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 4), data2: new Date(2023, 5, 7), descritivo: "Premiação da Campanha de matrículas 2022 – equipe gestora", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 6), data2: new Date(2023, 5, 6), descritivo: "Comissão de Educação/Diretiva", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    ...
    {data1: new Date(2023, 5, 8), data2: new Date(2023, 5, 8), descritivo: "Feriado Corpus Christi", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 9), data2: new Date(2023, 5, 9), descritivo: "Recesso (Dia permutável com 45144 – Domingo letivo Dia dos Pais)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 12), data2: new Date(2023, 5, 16), descritivo: "Período de aplicação da AV2 II BIM - corrigir, lançar notas no SAD e devolver aos estudantes até 5 dias úteis após a data da sua avaliação - FII ao Médio", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 15), data2: new Date(2023, 5, 21), descritivo: "Período de aplicação da AV2 - colocar nos primeiros dias as provas com mais complicação de correção.", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 13), data2: new Date(2023, 5, 15), descritivo: "Projeto Educador Fiel nas escolas", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 18), data2: new Date(2023, 5, 21), descritivo: "Encontro de Educação – CATRE", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 20), data2: new Date(2023, 5, 20), descritivo: "Conselho de Educação – CATRE", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 20), data2: new Date(2023, 5, 20), descritivo: "Início Campanha de Matrículas de Meio de Ano - digital", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    ...
    {data1: new Date(2023, 5, 20), data2: new Date(2023, 5, 30), descritivo: "Aplicação das provas diagnósticas de alfabetização – 2ª testagem", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 24), data2: new Date(2023, 5, 24), descritivo: "Dia do Ancião", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 23), data2: new Date(2023, 5, 23), descritivo: "2ª Chamada FI", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: "inf5"},
    {data1: new Date(2023, 5, 23), data2: new Date(2023, 5, 23), descritivo: "Data limite para o registro de todas as Atividades Avaliativas de Aprendizagem do 2º bimestre no SAD (prof)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 23), data2: new Date(2023, 5, 23), descritivo: "SAD ENCERRADO - 1º ENCERRAMENTO II BIM - FII ao Médio", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 25), data2: new Date(2023, 5, 25), descritivo: "Domingo Letivo – “Projeto Fair Play” - Olimpíada do Conhecimento (Matemática/ Bom de bíblia/Português/Redação) – Fase Final (Dia Letivo – dia permutado com recesso do dia 17/07)    ", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 26), data2: new Date(2023, 5, 26), descritivo: "Comissão de Educação Física USB (tarde)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 27), data2: new Date(2023, 5, 27), descritivo: "Comissão de Ciências da Natureza USB (tarde)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 27), data2: new Date(2023, 5, 27), descritivo: "Reunião de Bibliotecários USB (remoto)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 26), data2: new Date(2023, 5, 26), descritivo: "Conselho de Classe EI-FI (novo formato de acordo com o regimento)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 26), data2: new Date(2023, 5, 26), descritivo: "Conselho de Classe II BIM - FUND II e EM", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 27), data2: new Date(2023, 5, 27), descritivo: "Organização das convocações para a Recuperação Bimestral e Entrega das convocações para a Recuperação Bimestral aos alunos              ", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 28), data2: new Date(2023, 6, 4), descritivo: "Recuperação Bimestral II BIM - Fund II e Médio", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 29), data2: new Date(2023, 5, 29), descritivo: "Data limite - Entrega do Planejamento e Calendário Avaliativo do III BIM/FUND II e EM", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
    {data1: new Date(2023, 5, 30), data2: new Date(2023, 5, 30), descritivo: "Relatório mensal de notificações para pais (impresso) - Rudi (CAAB)", cal: "", resp: "", foto: "", detalhes: "", pais: false, niv: ""},
]
